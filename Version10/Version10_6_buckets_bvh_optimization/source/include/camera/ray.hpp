...
struct HitInfo{
    ...
    DEBUG_LINE(size_t bounds_test_count = 0)  // 光线与物体求交过程中，包围盒求交的次数
    DEBUG_LINE(size_t triangle_test_count = 0)  // 光线与物体求交过程中，三角形求交的次数
    DEBUG_LINE(size_t bounds_depth = 0)  // 光线与物体求交过程中，包围盒求交的最大深度
